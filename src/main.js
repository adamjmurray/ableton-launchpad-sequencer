...
export function modsum(mode) {
  controller.setModulationSummingMode(mode);
}
export function modslew(slew) {
...
export function velocity(velocity) {
...
export function trackreverse() {
  controller.reverseTrack();
}
export function trackrandom() {
